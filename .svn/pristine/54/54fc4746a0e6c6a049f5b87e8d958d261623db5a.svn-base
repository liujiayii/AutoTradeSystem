...
<el-table v-loading="loading2"
    ...
    <el-table-column label="首付款" prop="down_payment"></el-table-column>
    <el-table-column align="right">
        <template slot="header" slot-scope="scope">
            <el-input v-model="search" size="mini" placeholder="输入关键词进行搜索"/>
        </template>
    ...
    new Vue({
        ...
        methods: {
            ...
            getTable(page) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/AutoTradeSystem/selectAllSellingCustomer.action',
                    data: {
                        limit: 10,
                        page: page
                    },
