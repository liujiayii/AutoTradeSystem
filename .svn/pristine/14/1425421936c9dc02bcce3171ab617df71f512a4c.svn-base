...
public interface ExpenditureDao {
	...
	/**根据部门id分页查询*/
	List<Expenditure> selectExpenditureByDepartmentId(@Param("id") Long id, @Param("star")Integer star,@Param("limit")Integer limit);
	/**根据部门id查询数据数量*/
	Integer selectExpenditureCountByDepartmentId(Long id);
	/**根据支出项目模糊查询*/
