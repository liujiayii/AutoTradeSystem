...
<el-container class="main">
    <el-table v-loading="loading2"
        ...
        <el-table-column label="车型" prop="intention"></el-table-column>
        <el-table-column label="车牌" prop="brand"></el-table-column>
        <el-table-column label="评估金额（元）" prop="assessmentMoney"></el-table-column>
        <el-table-column label="评估人" prop="assessmentName"></el-table-column>
    ...
    new Vue({
        ...
        methods: {
            ...
            getTable(page) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/Assessment/selectAllAssessment.action',
                    data: {
                        limit: 10,
                        page: page
                    },
