...
<el-card shadow="hover">
  <el-container class="main">
    <el-table v-loading="loading2"
      ...
      <el-table-column label="强险金额" prop="brand" show-overflow-tooltip></el-table-column>
      <el-table-column label="保险类型" prop="brand" show-overflow-tooltip></el-table-column>
      <el-table-column label="商业险金额" prop="create_time" show-overflow-tooltip></el-table-column>
