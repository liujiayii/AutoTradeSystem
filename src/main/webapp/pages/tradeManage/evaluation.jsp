...
<el-container class="secondNav">
  ...
  <el-button class="btn" type="primary" icon="el-icon-plus" round
             onclick="window.location.href='evaluationEdit.jsp'">添加
  </el-button>
</el-container>
<el-card shadow="hover">
  <el-container class="main">
    <el-table v-loading="loading2"
              ...
              :data="tableData.data"
              style="width: 100%">
      <el-table-column label="序号" prop="id" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column label="评估金额（元）" prop="assessmentMoney" show-overflow-tooltip></el-table-column>
      <el-table-column label="评估人" prop="assessmentName" show-overflow-tooltip></el-table-column>
  ...
  new Vue({
    ...
    methods: {
      ...
      handleEdit(index, row) {
        ...
        window.location.href = 'evaluationEdit.jsp?id=' + row.id
      },
      ...
      getTable(page) {
        ...
        $.ajax({
          type: 'post',
          url: this.searchVal.length == 0 ? '/Assessment/selectAllAssessment.action' : '/Assessment/Allselect.action',
          data: {
            limit: 10,
            page: page,
            assessment_name: this.searchVal
          },
          dataType: 'json',
          success: (res) => {
            console.log(res)
