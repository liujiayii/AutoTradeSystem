...
<el-card shadow="hover">
  <el-container class="main">
    <el-table v-loading="loading2"
      ...
      <el-table-column label="项目" prop="expenditure" show-overflow-tooltip></el-table-column>
      <el-table-column label="摘要" prop="detailedExpenditure" show-overflow-tooltip></el-table-column>
      <el-table-column label="金额" prop="expenditureMoney" show-overflow-tooltip></el-table-column>
  ...
  new Vue({
    ...
    methods: {
      ...
      getTable(page) {
        ...
        $.ajax({
          type: 'post',
          url: this.searchVal.length == 0 ? '/Expenditure/selectExpenditureByDepartmentId.action' : '/Expenditure/hybridSelect.action',
          data: {
            limit: 10,
            page: page,
            s: this.searchVal,
