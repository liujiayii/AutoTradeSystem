...
<el-table v-loading="loading2"
    ...
    <el-table-column label="车牌号" prop="phone"></el-table-column>
    <el-table-column label="强险金额" prop="phone"></el-table-column>
    <el-table-column label="保险类型" prop="phone"></el-table-column>
    <el-table-column label="商业险金额" prop="position"></el-table-column>
