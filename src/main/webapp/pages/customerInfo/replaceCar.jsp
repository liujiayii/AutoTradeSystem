...
<el-container class="secondNav">
  ...
  <el-button class="btn" type="primary" icon="el-icon-plus" round
             onclick="window.location.href='replaceCarEdit.jsp'">添加
  </el-button>
</el-container>
<el-card shadow="hover">
  <el-container class="main">
    <el-table v-loading="loading2"
      ...
      <el-table-column label="意向车型" prop="brands" show-overflow-tooltip></el-table-column>
      <el-table-column label="创建时间" prop="date" :formatter="dateFormat" show-overflow-tooltip></el-table-column>
  ...
  new Vue({
    ...
    methods: {
      ...
      handleEdit(index, row) {
        ...
        window.location.href = 'replaceCarEdit.jsp?id=' + row.id
      },
      ...
      getTable(page) {
        ...
        $.ajax({
          type: 'post',
          url: this.searchVal.length == 0 ? '/selectAllSubCustomer.action' : '/selectBysubCustomer.action',
          data: {
            limit: 10,
            page: page,
            s: this.searchVal
